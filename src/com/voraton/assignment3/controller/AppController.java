package com.voraton.assignment3.controller;
...
import com.voraton.assignment3.database.Student;
import com.voraton.assignment3.database.StudentJDBCTemplate;
...
public class AppController {
	...
	public ModelAndView addNewStudentSubmit(@ModelAttribute("student") Student student) {
		...
		if( isValid ) {
			...
			return new ModelAndView("redirect:/", "message", "Succesfully Add New Student");
		}
